...
En alternativ metode til Ubuntu er at følge instruktionerne på
\url{https://github.com/scottkosty/install-tl-ubuntu} (Quick download
efterfulgt af \verb|sudo ./install-tl-ubuntu|).  Denne metode skulle
sikre, at den seneste version af \textsf{TeX Live} installeres.
