...
%    \expandafter\ifstrequal{true}{\item en pdf-fil , der hedder \texttt{#1\_<navn>.pdf} (f.eks. \texttt{#1\_jon.pdf})}{} %
  ...
  \ifnumequal{#3}{2}{Pdf-filen skal indeholde jeres rapport ifølge: \begin{itemize}\item\lstinline[language=console]{opgave.pdf}\end{itemize}  guiden og oversat fra \LaTeX. Husk at pdf-filen skal uploades ved siden af zip-filen på Absalon.}{} %
  \ifnumequal{#3}{3}{Pdf-filen skal indeholde jeres rapport ifølge: \begin{itemize}\item\lstinline[language=console]{rapport.pdf}\end{itemize} guiden og oversat fra \LaTeX. Husk at pdf-filen skal uploades ved siden af zip-filen på Absalon.}{} %
