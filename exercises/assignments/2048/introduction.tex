...
\item If two pieces of the same color touch after being tilted, then they are replaced by a single piece of double the value. For example, the board in \Cref{case1a} is tilted to the right, and the two red pieces are replaced with green piece.
  \begin{figure}
    \centering
