...
let randomChar (hist : int list) : char =
  ...
  printf "%A\r" (v,i) // rnd.Next seems to have a bug, and repeated calls are very often identical to the previous. A printf statement is included to increase the frequency.
  'a' + char i
