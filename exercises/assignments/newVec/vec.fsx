...
/// <param name="a">a multplicative scalar</param>
...
/// <param name="v">a vector</param>
/// <param name="a">an angle in the range 0..2 pi</param>
...
/// <param name="C">a canvas</param>
/// <param name="col">the color to be used</param>
/// <param name="v">a vector</param>
/// <param name="p">a vector giving the position of the tail to be drawn</param>
...
( // Interactively draw 36 spokes, centered in the middle, and where the arrow keys control an initial angular offset
  ...
  /// <param name="w">the width of the resulting canvas</param>
  /// <param name="h">the height of the resulting canvas</param>
  /// <param name="s">the angular offset of all spokesr</param>
  ...
  /// <param name="s">the present angular offset of all spokesr</param>
  /// <param name="k">the pressed key</param>
