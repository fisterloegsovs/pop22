...
I denne periode skal vi arbejde med funktionelle datastrukturer, input/output og undtagelser (exceptions).

% Input/Output og undtagelser (exceptions)
% skal svare til Kapitel 12 i Sporring
\learningPurposeTxt{
  {Funktionelle datastrukturer og inductive data types},
