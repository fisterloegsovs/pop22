...
\exerciseTitle{\exerciseNumber}{\typeLetter}{2.\ september - 16.\ september}{lørdag d.\ 17.\ september kl. 22:00}{Jon Sporring}
...
\end{center}
\continueExercises{\exerciseNumber ø}{../assignments/myFirstFSharp/}{}{add,function,helloWorld,helloName,typeError,countUpWhile,countUpRecursive}
\begin{center}
  \rule{0.7\textwidth}{1pt}
\end{center}
