...
beskrive jeres programmer. Den skal skrive i \LaTeX, indeholde et passende antal figurer og henvise til jeres programmer (i øvelsesholdets studio på Scratch' hjemmeside). \LaTeX\ koden (\texttt{.tex}) inklusiv billeder skal
