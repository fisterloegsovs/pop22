...
\item \input{../assignments/classes/counter}
\item \input{../assignments/classes/car}
\item \input{../assignments/classes/moth}
\item \input{../assignments/classes/drone}
\item \input{../assignments/classes/carAdvanced}
\item \input{../assignments/inheritance/customer}
\item \input{../assignments/inheritance/employee}
\item \input{../assignments/inheritance/mammals}
\end{enumerate}

\section*{Afleveringsopgave(r)}
\input{../assignments/prey/introduction}
\begin{enumerate}[label=10g.\arabic*,start=0]
\item \input{../assignments/wolvesNMoose/wolvesNMoose}
\end{enumerate}
