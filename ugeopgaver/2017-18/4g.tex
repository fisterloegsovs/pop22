...
\item Skriv en applikation i 2 varianter: 1 som benytter ovenstående bibliotek via \filename{fsharpi} og 1 som benytter det via \filename{fsharpc}.
\item Lav en fuld afprøvning af jeres bibliotek og ved brug af \filename{fsharpc}.
